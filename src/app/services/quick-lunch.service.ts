...
export class QuickLunchService
{
  ...
  private galettes: FoodInterface[] = [
  ...
  public getBurgers(): FoodInterface[] {
    return this.burgers;
  }

  public getPizzas(): FoodInterface[] {
    return this.pizzas;
  }

  public getGalettes(): FoodInterface[] {
